  ...
  return (
    <footer className='pt-16 bg-primary'>
      <div className='container mx-auto'>
        ...
        {/* form */}
        <from className='w-full max-w-3xl mx-auto flex flex-col md:flex-row gap-5 my-14'>
      ...
      <div className='py-10 border-t border-t-white/10'>
        <div className='container mx-auto'>
          <div className='text-center text-sm text-white/60'>Сopyright &copy; Photoland 2023.</div>
        </div>
      </div>
    </footer>
  )
